...
const stagedata={
  ...
  2:{
    ...
    "enemies":[{name:"ゆきだるま",hp:18,maxhp:18,attack:5,exp:5,gold:8,image:snowman_Icon,skill:"freeze"},
         {name:"ゆきねこ",hp:18,maxhp:18,attack:4,evade:0.15,exp:5,gold:10,image:cat_Icon}],
    "boss":{name:"アイスドラゴン",hp:40,maxhp:40,attack:7,exp:12,gold:20,image:dragon_Icon,skill:"freeze"},
  ...
  3:{
    ...
    "enemies":[{name:"マグマスライム",hp:24,maxhp:24,attack:6,exp:7,evade:0.15,gold:12,image:slime_Icon},
                {name:"フレイムホース",hp:32,maxhp:32,attack:8,exp:9,gold:16,image:horse_Icon,skill:"burn"}],
    "boss":{name:"ファイアドラゴン",hp:55,maxhp:55,attack:10,exp:15,gold:25,image:dragon_Icon,skill:"burn"},
